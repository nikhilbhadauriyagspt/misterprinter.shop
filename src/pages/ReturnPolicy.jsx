...
export default function ReturnPolicy() {
  return (
    ...
    >
      ...
      <p>
        To return an item, please email customer service at <a href="mailto:info@primefixsolutions.co">info@primefixsolutions.co</a> to obtain an Return Merchandise Authorization (RMA) number.
      </p>
      ...
      <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-3">
          <p className="flex items-center gap-3 text-blue-600 font-black tracking-tight">info@primefixsolutions.co</p>

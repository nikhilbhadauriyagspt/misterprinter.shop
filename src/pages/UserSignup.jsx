...
import { User, Mail, Lock, Phone, Eye, EyeOff, ArrowRight, Loader2, ShieldCheck, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 font-urbanist px-6 py-20 pt-40">
      <div className="max-w-[1000px] w-full grid grid-cols-1 lg:grid-cols-2 bg-white rounded-[3.5rem] shadow-2xl shadow-gray-200/50 overflow-hidden border border-gray-100">
        ...
        <div className="hidden lg:flex flex-col justify-between p-16 bg-blue-600 text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-5xl font-black tracking-tighter uppercase leading-none mb-6">
              Join the <br /> <span className="text-slate-900 italic">Future</span> Now.
            </h2>
            <p className="text-blue-100 text-lg font-bold leading-relaxed max-w-xs">
              Create your account to unlock professional support, bulk procurement, and exclusive tech access.
            </p>
          </div>

          <div className="relative z-10 space-y-6">
            <div className="flex items-center gap-4 text-xs font-black uppercase tracking-[0.2em] text-blue-900">
              <CheckCircle2 size={20} />
              Instant Activation
            </div>
            <p className="text-[10px] font-bold text-blue-200 uppercase tracking-widest">
              AUTHORIZED HP PARTNER NETWORK.
            </p>
          </div>
        </div>
        ...
        <div className="p-10 md:p-16 flex flex-col justify-center">
          <div className="mb-10">
            <h1 className="text-3xl font-black text-slate-900 uppercase tracking-tighter mb-2">Create ID.</h1>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Register for professional access</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full h-14 pl-14 pr-6 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:border-blue-600 outline-none text-xs font-bold uppercase transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="w-full h-14 pl-14 pr-14 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:border-blue-600 outline-none text-xs font-bold uppercase transition-all"
                  />
                  <button 
                    type="button"
            ...
            <button 
              disabled={loading}
              className="w-full h-16 bg-blue-600 text-white rounded-2xl flex items-center justify-center gap-4 text-xs font-black uppercase tracking-[0.3em] hover:bg-slate-900 transition-all shadow-2xl shadow-blue-600/20 active:scale-[0.98] disabled:opacity-50 mt-4"
            >
              {loading ? <Loader2 className="animate-spin" size={20} /> : <><span className="ml-4">Initialize Account</span> <ArrowRight size={18} /></>}
            </button>
          </form>
